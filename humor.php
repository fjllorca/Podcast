    ...
    <body>
        ...
        enctype="multipart/form-data">           
                ...
                <select name="categoria">                   
                    ...
                    <option value="cine">Programas de Cine</option>66666666666666666
...
echo "<h1>Humor</h1>";
echo "<table>";
$directoriohumor = opendir("./podsubidos/humor");
while ($archivohumor = readdir($directoriohumor)){
   $nombreArch = ucwords($archivohumor);  
   if(Archivo::getExtension($nombreArch)==="mp3"){
   echo "<tr><td>"; 
   echo " <audio controls>";  
   echo "<source src='./podsubidos/humor/$nombreArch'><b>&nbsp;$nombreArch</b></td>";
   echo "<td><b>&nbsp;$nombreArch</b></td>";
   echo "<audio></tr>";
   }
    elseif(Archivo::getExtension($nombreArch)==="jpg") {
   echo "<tr><td>";    
   echo "<img src='./podsubidos/humor/$nombreArch'></td>";
   echo "<td><b>&nbsp;$nombreArch</b></td>";
   echo "</tr>";
   } 
}
closedir($directoriohumor); 
echo "</table>";
?>
</div>
