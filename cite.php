...
echo "</br>";
        echo "<h1>Ciencia&tecnología</h1>";
echo "<table>";
$directoriocite = opendir("./podsubidos/cite");
while ($archivocite = readdir($directoriocite)){
   $nombreArch = ucwords($archivocite);  
   if(Archivo::getExtension($nombreArch)==="mp3"){
   echo "<tr><td>"; 
   echo " <audio controls>";  
   echo "<source src='./podsubidos/cite/$nombreArch'><b>&nbsp;$nombreArch</b></td>";
   echo "<td><b>&nbsp;$nombreArch</b></td>";
   echo "<audio></tr>";
   }
    elseif(Archivo::getExtension($nombreArch)==="jpg") {
   echo "<tr><td>";    
   echo "<img src='./podsubidos/cite/$nombreArch'></td>";
   echo "<td><b>&nbsp;$nombreArch</b></td>";
   echo "</tr>";
   } 
}
closedir($directoriocite); 
echo "</table>";
?>
</div>  
       </div>
