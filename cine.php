...
echo "</br>";
        echo "<h1>Cine</h1>";
        echo "<table>";
        $directoriocine = opendir("./podsubidos/cine");
        while ($archivocine = readdir($directoriocine)){
            $nombreArch = ucwords($archivocine);  
            if(Archivo::getExtension($nombreArch)==="mp3"){
                echo "<tr><td>"; 
                echo " <audio controls>";  
                echo "<source src='./podsubidos/cine/$nombreArch'><b>&nbsp;$nombreArch</b></td>";
                echo "<td><b>&nbsp;$nombreArch</b></td>";
                echo "<audio></tr>";
            }
             elseif(Archivo::getExtension($nombreArch)==="jpg") {
                echo "<tr><td>";    
                echo "<img src='./podsubidos/cine/$nombreArch'></td>";
                echo "<td><b>&nbsp;$nombreArch</b></td>";
                echo "</tr>";
             } 
        }
closedir($directoriocine); 
echo "</table>";
?>
     </div>
