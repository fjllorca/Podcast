...
require './clases/Archivo.php';
    echo "<h1 >Musica</h1>";
    echo "<table>";
    $directoriomusica = opendir("./podsubidos/musica");
        while ($archivomusica = readdir($directoriomusica)){
        $nombreArch = ucwords($archivomusica);  
            if(Archivo::getExtension($nombreArch)==="mp3"){
                echo "<tr><td>"; 
                echo " <audio controls>";  
                echo "<source src='./podsubidos/musica/$nombreArch'><b>&nbsp;$nombreArch</b></td>";
                echo "<td><b>&nbsp;$nombreArch</b></td>";
                echo "<audio></tr>";
            }
             elseif(Archivo::getExtension($nombreArch)==="jpg") {
                echo "<tr><td>";    
                echo "<img src='./podsubidos/musica/$nombreArch'></td>";
                 echo "<td><b>&nbsp;$nombreArch</b></td>";
                echo "</tr>";
            } 
    }
closedir($directoriomusica); 
echo "</table>";
?>
 </div>
